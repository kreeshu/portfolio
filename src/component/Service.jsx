...
function Service() {
  return (
    <div className='my-20'>
        ...
        <Box img="https://websitedemos.net/personal-portfolio-02/wp-content/uploads/sites/770/2021/02/settings.png" title="Web Development" text="Expert web development services tailored to your needs. From responsive design to backend functionality, we create stunning, user-friendly websites that drive results and elevate your online presence."/>
        </div>
    </div>
  )
}
